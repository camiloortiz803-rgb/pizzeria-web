...
const PIZZAS = [
  { 
    id: 'haw', 
    name: 'Hawaiana', 
    desc: 'Piña, jamón y queso.', 
    image: 'images/hawaina.jpg'
  },
  { 
    id: 'camp', 
    name: 'Campesina', 
    desc: 'Chorizo, maíz, maduro y queso.', 
    image: 'images/campesina.jpg'
  },
  { 
    id: 'polloch', 
    name: 'Pollo con Champiñón', 
    desc: 'Pollo desmechado, champiñones, jamón y queso.', 
    image: 'images/champiñones.jpg'
  },
  { 
    id: 'kab', 
    name: 'Kabano', 
    desc: 'Kabano y queso.', 
    image: 'images/Kabano.jpg'
  },
  { 
    id: 'jam', 
    name: 'Jamón y Queso', 
    desc: 'Jamón y queso.', 
    image: 'images/jamon-queso.jpg'
  },
  { 
    id: 'pepp', 
    name: 'Pepperoni', 
  ...
  { 
    id: 'mex', 
    name: 'Mexicana', 
    desc: 'Carne desmechada, maduro, maíz, jamón y queso.', 
    image: 'images/mexicana.jpg'
  },
  { 
    id: 'samba', 
    name: 'Samba', 
    desc: 'Tocineta, Kabano, maduro, maíz y queso.', 
    image: 'images/zamba.jpg'
  },
  { 
    id: 'tres', 
    name: 'Tres Carnes', 
    desc: 'Chorizo, pollo en BBQ, carne molida y queso.', 
    image: 'images/3 carnes.jpg'
  },
  { 
    id: 'tent', 
    name: 'Tentación', 
    desc: 'Piña, pollo, kabano, jamón y queso.', 
    image: 'images/tentacion.jpg'
  },
  { 
    id: 'mad', 
    name: 'Maduro', 
    desc: 'Maduro, tocineta y queso.', 
    image: 'images/maduro.jpg'
  },
  { 
    id: 'polloesp', 
    name: 'Pollo Especial', 
    desc: 'Pollo en salsa BBQ, tocineta, maíz y queso.', 
    image: 'images/pollo-especial.jpg'
  },
  { 
    id: 'veg', 
    name: 'Vegetariana', 
    desc: 'Champiñón, tomate, cebolla, maíz y queso.', 
    image: 'images/vegetariana.jpg'
  },
  { 
    id: 'marga', 
    name: 'Margarita', 
    desc: 'Tomates, albahaca y queso.', 
...
function renderPizzas() {
  ...
  PIZZAS.forEach(pizza => {
    ...
    card.className = 'card';
    card.innerHTML = `
      <div class="thumb"><img src="${pizza.image}" alt="${pizza.name}" /></div>
      <div>
        <h4>${pizza.name}</h4>
        <p>${pizza.desc}</p>
      </div>
